...
// XXX: temporary garbage. This is needed, because we are extending a
// CS class in TS and then will be extending further in CS. In a such
// scenario static members are copied in a way that it prevents further
// copying in subclasses, so we manually override TS' __extends() to
// allow this.
LayoutCanvas.define = HasProps.define
LayoutCanvas.getters = HasProps.getters
LayoutCanvas.internal = HasProps.internal
LayoutCanvas.override = HasProps.override
